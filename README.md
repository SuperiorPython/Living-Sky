...
_Currently showing: **Tokyo, Japan** — 2026-08-01 11:08 UTC_
<!--SKY:END-->
...
_Solar system, viewed from above — **2026-08-01 11:08 UTC**. Planet angles are real (ecliptic longitude); distances are log-scaled so the outer planets stay on the page._
<!--SOLAR:END-->
